...
package com.huaya.rxlifecycle.android.events;

import android.support.annotation.CheckResult;
import android.support.annotation.NonNull;
import android.view.View;

import com.huaya.rxlifecycle.LifecycleTransformer;
import com.huaya.rxlifecycle.OutsideLifecycleException;


import rx.Observable;
import rx.functions.Func1;

import static com.huaya.rxlifecycle.RxLifecycle.bind;
...
public class RxLifecycleAndroid {
     ...
     * <p>
     * This helper automatically自动 determines决定 (based on the lifecycle sequence itself) when the source
     * should stop emitting发射 items. In the case that the lifecycle sequence is in the
     * creation phase阶段 (CREATE, START, etc) it will choose the equivalent等同的 destructive销毁 phase (DESTROY,
    ...
    // Figures out which corresponding相应的 next lifecycle event in which to unsubscribe, for Fragments
